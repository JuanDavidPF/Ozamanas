...
namespace Ozamanas.Energy
{
    ...
    public class EnergyPool : Cell
    {
        ...
        [SerializeField] private CellData activeEnergyCellData;
       ...
       protected override void OnUpdateCellData()
       {
            ...
            if(data == activeEnergyCellData) generatorReference.ResumeGeneration();
            else generatorReference.StopGeneration();
